...
import com.shubh.learn.MainActivity
import com.shubh.learn.R
import com.shubh.learn.SebateksApp.Companion.context
...
//      {START STRING TO JSON & JSON TO STRING}
        ...
        fun btnClickAnimation(view: View) {
            val fadeAnimation = AnimationUtils.loadAnimation(view.context, R.anim.slide_in_right)
...
//            val languageToLoad = "en" // your language
        ...
        fun addWatermark(res: Resources, source: Bitmap, mScreenwidth: Int): Bitmap {
            ...
            // Load the watermark
            watermark = BitmapFactory.decodeResource(res, R.drawable.logo_splash)
...
//                }
        ...
        fun getIntentForPush2(
            ctx: Context,
            mNotificationData: RemoteMessage?
        ): Intent? {
            var mIntent: Intent? = null
            if (mNotificationData != null) {
//                if (mPrefMgr.getUserId() != null && !mPrefMgr.getUserId().isEmpty()) {
...
//            var packageName= "com.quixom.deviceinfo"
        ...
        fun setEnableView(edtView: TextInputEditText, isViewEditable: Boolean) {
            if (isViewEditable) {
                ...
                edtView.setTextColor(edtView.context.getColor(R.color.colorPrimary))
            }
        }
